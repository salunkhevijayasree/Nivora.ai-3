...
import { Moon, Bell, UserCircle, Activity, Bot, Sparkles } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-lg bg-gray-900/80 border-b border-gray-800">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        {/* Right Upper-Hand Actions (Clean Inline Layout — Dark Mode Only) */}
        <div className="flex items-center gap-3">
          ...
          <Link to="/patient/profile" className="flex items-center gap-2 pl-2 border-l border-gray-800">
            <div className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center text-hospital-400">
              <UserCircle size={24} />
            </div>
            <span className="text-sm font-medium hidden sm:block text-gray-200">Patient Portal</span>
          </Link>
        </div>
